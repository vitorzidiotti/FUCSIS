...
from datetime import date # Importa 'date' para a validação do 'min_date'

# --- DEFINA SUAS UNIDADES DE MEDIDA AQUI ---
UNIDADES_MEDIDA = [
...
def adicionar_produto():
    ...
    today_str = date.today().isoformat() # Pega data de hoje para 'min' no input date
    ...
    if request.method == 'POST':
        ...
        if sucesso:
            ...
            # Reexibe o form com dados preenchidos e lista de unidades
...
def editar_produto(id_produto):
    ...
    if request.method == 'POST':
        ...
        if sucesso:
            ...
            # Recarrega dados para reexibir o form com a mensagem de erro
            ...
            if erro_get:
                ...
                return redirect(url_for('produto.gerenciar_produtos'))
            # Passa produto, unidades e min_date novamente
    ...
    if erro or not produto:
        ...
        return redirect(url_for('produto.gerenciar_produtos'))
    # Passa produto, unidades e min_date
